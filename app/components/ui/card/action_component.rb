...
module Ui
  module Card
    ...
    # action from stretching the title row and pushing the description down.
    class ActionComponent < Ui::Base
      data_slot 'card-action'

      class_variants(base: 'col-start-2 row-start-1 flex h-0 items-center self-center justify-self-end')

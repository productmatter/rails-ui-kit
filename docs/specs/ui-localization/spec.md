...
- **Chrome** is what the kit says on its own, that no call site ever writes: a toast's
  ...
  unsaved-changes prompt, Select's search-field placeholder. A host doesn't pass these
